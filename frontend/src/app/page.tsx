...
export default async function Home() {
  ...
  return (
    <div className="w-full px-4 md:px-8 py-2 min-h-[calc(100svh-4rem)] gap-8 flex flex-col justify-center text-primary">
        ...
        <div className="flex flex-col gap-2 items-center p-2 border rounded-md">
          ...
          <div className="w-full grid grid-cols-2 gap-4 bg-white rounded-md p-4">
            {barang.data.length < 1 ? (
              <p className="text-sm text-primary/75 col-span-2">
